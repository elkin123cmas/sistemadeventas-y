...
$sentencia = $pdo->prepare("INSERT INTO tb_almacen (codigo, nombre, descripcion, stock, stock_minimo, stock_maximo, precio_compra, precio_venta, fecha_ingreso, imagen, id_usuario, id_categoria, fyh_creacion) 
...
if ($sentencia->execute()) {
    session_start();
    $_SESSION['mensaje'] = "El producto fue registrado exitosamente";
