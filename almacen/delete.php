...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Datos del Producto a eliminar : <?php echo $nombre; ?></h1>
                </div><!-- /.col -->
                ...
                <div class="col-md-12">
                    <div class="card card-danger">
                        <div class="card-header">
                            <h3 class="card-title">¿Deseas eliminar el producto?</h3>
                                ...
                                <div class="col-md-12">
                                    <form action="../app/controllers/almacen/delete.php" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <center>
                                                        <img src="<?php echo $URL . "/almacen/img_productos/" . $imagen; ?>" width="100%" alt="imagen fallida">
                                                    </center>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button class="btn btn-danger"><i class="fa fa-trash"> Eliminar Producto</i></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
