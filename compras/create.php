...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Registra una nueva compra</h1>
                </div><!-- /.col -->
            ...
            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="stock" id="stock" class="form-control" style="background-color:tan" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="celular" disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?php echo $contador_de_compras; ?>" id="numero_compra" hidden>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="stock_actual" style="background-color: tan; text-align:center;" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                        ...
                        <div id="respuesta_create">ss</div>
